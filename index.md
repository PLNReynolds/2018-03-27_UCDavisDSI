...
venue: "UC Davis Data Science Initiative"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Shields 360, One Shields Avenue, Davis, CA 95616"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
email: ["plreynolds@ucdavis.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
